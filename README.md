...
Draw your database schema using [our db tool](https://kitt.lewagon.com/db/new) 
...
- Don't neglect the view. If you add a form, make it a nice, centered and responsive Bootstrap form.
- If you code a flats list, build a nice Bootstrap grid (for example, with flat picture on the left and flat info on the right..).
